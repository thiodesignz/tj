          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[12px] w-full">
            {items.map((template) => (
              <a
                ...
                className="bg-[#eee] flex flex-col h-[350px] md:h-[450px] lg:h-[581px] overflow-hidden rounded-[36px] group"
              >
                ...
                <div className="p-[4px]">
                  <div className="bg-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-[8px] px-[16px] py-[16px] md:px-[20px] md:py-[24px] rounded-[32px]">
